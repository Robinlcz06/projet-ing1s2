#include "badland_robin.h"
#include <allegro.h>
#include <stdio.h>

BITMAP *fond_menu = NULL; // ✅ Déclaration globale
/*main de ce programme
int main() {
...
void demander_pseudo(char *pseudo) {
    ...
    while (!key[KEY_ESC] && !saisie_finie) {
        ...
        for (int i = 0; i < pos; i++) {
            ...
            textout_ex(buffer, font, lettre, start_x + i * 20, SCREEN_H/2, makecol(0, 255, 0), -1);
        }
